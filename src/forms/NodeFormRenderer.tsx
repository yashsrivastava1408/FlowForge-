...
function KeyValueField({ control, name, label }: { control: any; name: string; label: string }) {
  ...
  return (
    <div className="space-y-3">
      ...
      >
        <Plus className="w-3.5 h-3.5 group-hover:scale-125 transition-transform" /> Add {label}
      </button>
    </div>
  );
}
